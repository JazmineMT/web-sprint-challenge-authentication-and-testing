...
const defaultUser = { username: "jazzy-J2", password: "password25"}
const newUser = { username: "jazzy-J", password: "password25"}
...
describe('server', ()=> {
    ...
    describe('Register success', () => {
        ...
        it('Should get a status of 201', () => {
            ...
            .send(newUser)
            .then( res => {
                expect(res.body.data.username).toBe('jazzy-J')
    ...
    describe('Login success', () => {
        ...
        it('Should get a status of 401 becuase of wrong username', () => {
            return request(server).post("/api/auth/login")
            .send({ username: "jazzy-", password: "password25"})
            .then( res => {
                expect(res.status).toBe(401)
            })
        })
